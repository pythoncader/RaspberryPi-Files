#add a button on gpio 21 and ground, then add "sudo python3 /home/pi/Desktop/coding/RaspberryPi-Files/raspberrypistuff/CadeShutdown.py &" (edit this directory as necessary) to end of /etc/rc.local (before exit 0)This runs this
